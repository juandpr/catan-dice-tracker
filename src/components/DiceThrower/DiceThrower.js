    ...
    return (
      <View style={styles.diceThrower}>
        <View style={[styles.column, styles.firstColumn]}>
          ...
          <View style={styles.buttonContainer}><DiceButton onPress={() => {this.props.throwDice(4)}} value="4"></DiceButton></View>
        </View>
        <View style={styles.column}>
          ...
          <View style={styles.buttonContainer}><DiceButton onPress={() => {this.props.throwDice(7)}} value="7"></DiceButton></View>
        </View>
        <View style={styles.column}>
          ...
          <View style={styles.buttonContainer}><DiceButton onPress={() => {this.props.throwDice(10)}} value="10"></DiceButton></View>
        </View>
        <View style={styles.column}>
          ...
          <View style={styles.buttonContainer}><DiceButton onPress={() => {this.props.undoDice()}} value="Undo"></DiceButton></View>
        </View>
      </View>
    );
  }
